...
echo "SALT_TRANSFER_VALIDATOR_V2: $SALT_TRUSTED_FORWARDER_IMPLEMENTATION"
echo "EXPECTED_VALIDATOR_ADDRESS_V2: $EXPECTED_TRUSTED_FORWARDER_IMPLEMENTATION_ADDRESS"
...
forge script script/common/DeployTrustedForwarderImplementation.s.sol:DeployTrustedForwarderImplementation \
  --gas-price $GAS_PRICE \
