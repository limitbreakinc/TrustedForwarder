...
echo "SALT_TRUSTED_FORWARDER_IMPLEMENTATION: $SALT_TRUSTED_FORWARDER_IMPLEMENTATION"
echo "EXPECTED_TRUSTED_FORWARDER_IMPLEMENTATION_ADDRESS: $EXPECTED_TRUSTED_FORWARDER_IMPLEMENTATION_ADDRESS"
echo "SALT_TRUSTED_FORWARDER_FACTORY: $SALT_TRUSTED_FORWARDER_FACTORY"
...
forge script script/common/DeployTrustedForwarderFactory.s.sol:DeployTrustedForwarderFactory \
  --gas-price $GAS_PRICE \
